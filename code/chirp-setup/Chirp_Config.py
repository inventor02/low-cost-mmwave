...
if B < 1000000000:
    ...
    # for idleTimeConst 1LSB = 10ns - default in mmWS is 1000 so 10us - these values of 2,3.5,5,7 have been taken from a TI recommended settings table for when digOutSampleRate>5Msps - the 3 is just an arbitrary time taken for the system to settle before ramping up the next chirp
