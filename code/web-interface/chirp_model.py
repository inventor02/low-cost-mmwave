...
def calculate_chirp(Dres, Vres):
    ...
    Ares = Theta_res_straight
    return Dres, Vres, Ares, startFreqConst, idleTimeConst, adcStartTime, rampEndTime, freqSlopeConst, digOutSampleRate, loopCount, periodicity
